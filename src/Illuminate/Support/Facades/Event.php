 ...
 * @method static \Illuminate\Events\Dispatcher before(callable|string|array $callbacks, string|array|null $events = null)
 * @method static \Illuminate\Events\Dispatcher after(callable|string|array $callbacks, string|array|null $events = null)
 * @method static \Illuminate\Events\Dispatcher failure(callable|string|array $callbacks, string|array|null $events = null)
 *
